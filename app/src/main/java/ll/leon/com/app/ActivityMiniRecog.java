    ...
    public void onEvent(String name, String params, byte[] data, int offset, int length) {
        ...
        if (name.equals(SpeechConstant.CALLBACK_EVENT_ASR_PARTIAL)) {
            try {
                ...
                String bestResult = jsonObject.optString("best_result");
                Log.d("ActivityMiniRecog", bestResult);

                if ("你好小度".equals(bestResult)) {
                    Toast.makeText(this, "你好小度   ddd", Toast.LENGTH_SHORT).show();
                }

                txtResult.setText(bestResult);
            } catch (JSONException e) {


            }
            if (params.contains("\"nlu_result\"") ||params.contains("\"best_result\"")) {
